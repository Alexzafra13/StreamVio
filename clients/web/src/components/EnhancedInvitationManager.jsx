...
function EnhancedInvitationManager() {
  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-lg p-6">
      <h2 className="text-2xl font-bold mb-6">Gestión de Invitaciones</h2>
      ...
      {newInvitation && (
        <div className="bg-green-800 p-4 rounded-lg mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
            ...
            >
              {copySuccess === "¡Copiado!" ? copySuccess : "Copiar Código"}
            </button>
          </div>
          <div className="mb-2">
            <p className="text-sm text-gray-300 mb-1">Enlace de Invitación:</p>
                  ...
                  <tr key={invitation.id}>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      {!isUsed && !isExpired && (
                        <button
                          onClick={() =>
                            copyToClipboard(getInvitationLink(invitation.code))
                          }
